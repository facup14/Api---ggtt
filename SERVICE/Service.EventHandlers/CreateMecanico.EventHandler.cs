...
{
    public class CreateMecanico : INotificationHandler<CreateMecanicosCommand>
    {
        ...
        public async Task Handle(CreateMecanicosCommand notification, CancellationToken cancellationToken)
        {
